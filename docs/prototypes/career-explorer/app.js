...
const CLUSTERS = [
  ...
  {name:'Arts, Entertainment & Design',  icon:'🎨',  img:'https://images.unsplash.com/photo-1470229722913-7c0e2dbbafd3?w=800&q=80', desc:'Express ideas through art, performance, and digital creation.',   subs:['Design & Digital Arts','Fashion & Interiors','Fine Arts','Lighting & Sound Technology','Media Production & Broadcasting','Performing Arts']},
  ...
  {name:'Public Service & Safety',       icon:'🛡️', img:'https://images.unsplash.com/photo-1576707995936-a6cffe26ef7b?w=800&q=80', desc:'Protect people and help communities stay safe and supported.',    subs:['Emergency Response','Judicial Systems','Local, State & Federal Services','Military & National Security','Public Safety']},
